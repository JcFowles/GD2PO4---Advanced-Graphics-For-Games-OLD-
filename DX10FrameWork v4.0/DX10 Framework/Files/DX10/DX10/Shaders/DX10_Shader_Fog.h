...
//* Description : Shader Instructions for a the Fog shader
//* Author :	Jc Fowles
...
//
//	/***********************
//	* DX10_Shader_Fog: Default Constructor for Lit Texture Shader class
//	* @author: Jc Fowles
//	* @return:
//	********************/
//	DX10_Shader_Fog()
...
//	* @return: void
//	********************/
//	void Render(TFog _FogDes, eTech_Fog _eTech)
//	{
...
//		m_pDX10_Renderer->SetPrimitiveTopology(_FogDes.pMesh->GetPrimTopology());
//
...
//				D3DXMATRIX matWorld = *_FogDes.pMatWorld;
//
//				m_pMatWorld->SetMatrix((float*)&matWorld);
//				m_pMatTex->SetMatrix((float*)&matTex);
//				m_pMapDiffuse->SetResource(_FogDes.pTexBase);
//				m_pMapSpecular->SetResource(m_pSpecularTex);
//				m_pFogStart->SetFloat(_FogDes.fogStart);
//				m_pFogRange->SetFloat(_FogDes.fogRange);
//				m_pFogColor->SetRawValue(_FogDes.fogColor, 0, sizeof(D3DXCOLOR));
//				
//				m_pCurrentTech->GetPassByIndex(p)->Apply(0);
//				_FogDes.pMesh->Render();
//			}
//		}
//	}
//
