...
public:
	...
	********************/
	...
	/***********************
	* SetClearColor: Set the clear color of the device
	* @author: Jc Fowles
	* @parameter: _clearColor: Color to be set as the clear color
	* @return: void
	********************/
	void SetClearColor(D3DXCOLOR _clearColor){ m_clearColor = _clearColor; };
	...
	********************/
	...
	/***********************
	* GetClearColor: Get the clear color of the device
	* @author: Jc Fowles
	* @return: D3DXCOLOR: The Clear color of the DX10 device
	********************/
	...
	*******************************/
	...
	/***********************
	* InitialiseParicleSystem: Initialise the particle System
	* @author: Jc Fowles
	* @parameter: _fxFileName: File name of the .fx file that hold the particle systems effects
	* @parameter: _textureFolder: Folder name that holds all the textures used within this particle system
	* @parameter: _textureFiles: List of all the textures file names used within this particle system
	* @parameter: _maxParticles: max number of particles
	* @parameter: _pParticleSystem: Output of the initialised particle system
