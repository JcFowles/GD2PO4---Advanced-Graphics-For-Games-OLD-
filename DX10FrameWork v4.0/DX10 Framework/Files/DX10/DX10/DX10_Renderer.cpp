...
bool DX10_Renderer::Initialise(int _clientWidth, int _clientHeight, HWND _hWND)
{
	...
	m_clearColor = d3dxColors::DeepPink;
...
bool DX10_Renderer::InitialiseParicleSystem(std::string _fxFileName, std::string _textureFolder, std::vector<std::string> _textureFiles, UINT _maxParticles, DX10_ParticleSystem* _pParticleSystem)
{
