...
public:
	...
	* @return: bool: Successful or not
	********************/
	bool Initialise(DX10_Renderer* _pRenderer, DX10_Mesh* _pMesh, DX10_Shader_LitTex* _pShader, std::string _texName, float _scrollTime, v2float _scrollDir);
...
protected:
	...
	v2float m_scrollDirection;
	v2float m_ScrollTexCoord;
	float m_scrollTime;
	float m_scrollSpeed;
};
