...
public:
	...
	* @author: Callan Moore	and Jc Fowles
	* @Parameter: _hInstance: Handle to the current instance
	* @return: bool: Successful or not
	********************/
...
private:
	...
	// Shader
	DX10_Shader_LitTex* m_pLitTexShader;
	DX10_Shader_Sprite* m_pSpriteShader;
	DXSprite* m_pUISprite;

	// Meshs
	DX10_Mesh* m_pTerrainMesh;
	DX10_Mesh* m_pWaterMesh;
	...
	DX10_ParticleSystem* m_pRain;
	DX10_ParticleSystem* m_pFallingStars;
